...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h4>Search Data User</h4>
                </div>
                <div class="col-6">
                    <a href="{{route('user-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('user-search')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="id" class="form-control" placeholder="Masukkan ID User" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
