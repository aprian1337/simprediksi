    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{route('donatur-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('donatur-search')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="Username">ID DONATUR</label>
                    <input type="text" name="id_donatur" class="form-control" placeholder="Masukkan ID Donatur" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
