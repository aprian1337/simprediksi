...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h4>Search Data Kecamatan</h4>
                </div>
                <div class="col-6">
                    <a href="{{route('kecamatan-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('kecamatan-search')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="Username">ID Kecamatan</label>
                    <input type="text" name="id_kecamatan" class="form-control" placeholder="Masukkan ID Kecamatan" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
