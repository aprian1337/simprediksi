...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h4>Search Data Bantuan</h4>
                </div>
                <div class="col-6">
                    <a href="{{route('bantuan-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('bantuan-search')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="Username">ID BANTUAN</label>
                    <input type="text" name="id_bantuan" class="form-control" placeholder="Masukkan ID Bantuan" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
