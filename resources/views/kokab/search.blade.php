    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{route('kokab-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('kokab-search')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="Username">ID KOKAB</label>
                    <input type="text" name="id_kokab" class="form-control" placeholder="Masukkan ID Kokab" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
