...
<div class="container-fluid mt-5">
    <a href="{{route('jenis-korban')}}" class="btn btn-dark mt-4"><i class="fas fa-arrow-left"></i>&nbsp; Back</a>
    ...
    <div class="card">
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>{{$search->id_jenis_korban}}</td>
                        <td>{{$search->jenis_korban}}</td>
                        <td>{{$search->keterangan}}</td>
                        <td>
                            <div>
                                <form action="edit/{{$search->id_jenis_korban}}" method="POST">
                                    @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{route('jenis-korban-delete', $search->id_jenis_korban)}}" method="POST">
                    @csrf
