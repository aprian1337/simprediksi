...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h4>Search Data Jenis Korban</h4>
                </div>
                <div class="col-6">
                    <a href="{{route('jenis-korban-create')}}" class="btn btn-outline-success float-right"><i class="fas fa-plus"></i>&nbsp; Tambah data</a>
                </div>
            </div>
            <hr>
            <form action="{{route('jenis-korban-search')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="Username">ID Jenis Korban</label>
                    <input type="text" name="id_jenis_korban" class="form-control" placeholder="Masukkan ID Jenis Korban" required>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
